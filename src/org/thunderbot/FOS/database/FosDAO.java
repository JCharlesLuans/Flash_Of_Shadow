...
public class FosDAO {
    ...
    public Competence getCompetenceById(int id) {
        ...
        try {
            ...
            aRetourner.setDescription(rs.getString(COMPETENCE_DESCRIPTION));
    ...
    public ArrayList<Competence> getCompetenceByPersonnage(int idPersonnage) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                tmp.setDescription(rs.getString(COMPETENCE_DESCRIPTION));
    ...
    public ArrayList<PNJ> getPnjByIdMap(String id) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                tmp.getStats().setArmure(rs.getInt(PNJ_STAT_ARMURE));
                tmp.getStats().setAgilite(rs.getInt(PNJ_STAT_AGILITE));
                tmp.getStats().setDexterite(rs.getInt(PNJ_STAT_DEXTERITE));
                tmp.getStats().setEndurance(rs.getInt(PNJ_STAT_ENDURANCE));
                tmp.getStats().setForce(rs.getInt(PNJ_STAT_FORCE));
                tmp.getStats().setIntelligence(rs.getInt(PNJ_STAT_INTELLIGENCE));
                tmp.getStats().setSagesse(rs.getInt(PNJ_STAT_SAGESSE));
